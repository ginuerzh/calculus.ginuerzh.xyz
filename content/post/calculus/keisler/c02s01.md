...
$$
\frac{\Delta{y}}{\Delta{x}} = \frac{(\sqrt{x + \Delta{x}} - \sqrt{x})}{\Delta{x}} \centerdot \frac{(\sqrt{x + \Delta{x}} + \sqrt{x})}{(\sqrt{x + \Delta{x}} + \sqrt{x})}
$$
...
<center>![figure 2.1.4](/img/calculus/keisler/f2.1.4.gif)</center>

<center>**Figure 2.1.4**</center>
...
$$
= -\frac{1}{x \centerdot x} = -\frac{1}{x^2}.
$$
...
<center>![figure 2.1.5](/img/calculus/keisler/f2.1.5.gif)</center>

<center>**Figure 2.1.5**</center>
...
<center>![figure 2.1.6](/img/calculus/keisler/f2.1.6.gif)</center>

<center>**Figure 2.1.6**</center>
...
<center>![figure 2.1.7](/img/calculus/keisler/f2.1.7.gif)</center>

<center>**Figure 2.1.7**</center>
